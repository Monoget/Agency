...
$(function(){		
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".header-transparent .logo-dark img").attr("src", "images/logo-white.png");
		jQuery(".logo-dark img, .header-transparent.text-black .logo-dark img").attr("src", "images/logo.png");
    ...
    jQuery(".skin-2").on('click',function(){
		...
		jQuery(".header-transparent .logo-dark img").attr("src", "images/logo-white.png");
		jQuery(".logo-dark img, .header-transparent.text-black .logo-dark img").attr("src", "images/logo-2.png");
		jQuery(".logo-white img").attr("src", "error-404.html");
        return false;
    });
	jQuery(".skin-3").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-3.css");
		jQuery(".header-transparent .logo-dark img").attr("src", "images/logo-white.png");
		jQuery(".logo-dark img, .header-transparent.text-black .logo-dark img").attr("src", "images/logo-3.png");
		jQuery(".logo-white img").attr("src", "error-404.html");
        return false;
    });
